...
const partners = [
  {
    ...
    role: "Senior Partner",
    image: "https://asset.mrm-advocates.co.ke/Abdalla%20Mohamed.jpeg",
  ...
  },
  {
    name: "Rama Mwanaidi",
    role: "Senior Partner",
    image: "https://asset.mrm-advocates.co.ke/Rama.jpeg",
    description: "Renowned litigator representing clients in complex commercial disputes and high-profile litigation across East Africa.",
    fullBio: "Rama Mwanaidi is a formidable force in the courtroom, known for her sharp legal mind and persuasive advocacy. With a career spanning two decades, she has successfully represented clients in landmark commercial disputes and complex litigation. She is highly regarded for her strategic approach to dispute resolution and her commitment to achieving the best possible outcomes for her clients.",
    expertise: ["Litigation", "Commercial Disputes", "Public Law", "Family Law"],
    education: ["LL.B, University of Nairobi", "Post Graduate Diploma, Kenya School of Law"],
  ...
  },
  {
    ...
    role: "Senior Partner",
    image: "https://asset.mrm-advocates.co.ke/Abdirahman%20Mursal.jpeg",
    description: "Trusted adviser on real estate law, property development, and licensed arbitration, guiding landmark projects and resolving complex disputes.",
    fullBio: "Mursal Abdirahman is a world-class Sheikh and legal expert specializing in Real Estate, Property Law, and Arbitration. He brings a unique blend of ethical leadership and deep legal knowledge to property development and dispute resolution. He is a member of the Chartered Institute of Arbitrators and has advised on numerous multi-billion shilling real estate projects, from residential estates to commercial hubs. His meticulous attention to detail and proactive problem-solving ensure that even the most complex transactions and disputes are executed seamlessly.",
    expertise: ["Real Estate", "Licensed Arbitration", "Conveyancing", "Banking Law"],
    education: ["LL.B, Osmania University, Hyderabad, India", "Chartered Institute of Arbitrators (MCIArb)", "Post Graduate Diploma, Kenya School of Law"],
